# Monty Hall Problem simulator where the user defines the number of trials
...
ndoors = 3
while True:
    ntrials = int(input("Number of trials of the Monty Hall Problem to run: "))
    try:
...
print(f'Proportion of wins without switching: {nwins_without_switch/ntrials}')
print(f'Proportion of wins with switching: {nwins_with_switch/ntrials}')
